...
class Table(object):
    ...
    def newMessage(self,account_id=None,to_address=None,from_address=None,
                 ...
                 html=False,doCommit=False,headers_kwargs=None,arrival_id=None,agency_id=None,tmp_code=None,**kwargs):
        ...
        message_to_dispatch = self.newrecord(in_out='O',
                            ...
                            html=html,dbstore=dbstore,arrival_id=arrival_id,agency_id=agency_id,template_code=tmp_code,**kwargs)
    ...
    def newMessageFromUserTemplate(self,record_id=None,letterhead_id=None,
                            ...
                            cc_address=None,bcc_address=None,from_address=None, account_id=None,arrival_id=None,agency_id=None, **kwargs):
        ...
        return self.newMessage(**mail_handler.mailParsFromUserTemplate(record_id=record_id,letterhead_id=letterhead_id,
                            ...
                            cc_address=cc_address,bcc_address=bcc_address,from_address=from_address, account_id=account_id,arrival_id=arrival_id,agency_id=agency_id,tmp_code=template_code, **kwargs))
